...
layer_x("tv", ((x - room_width / 2) / 2))
layer_y("tv", ((y - room_height / 2) / 2))
var layer_tv_id = layer_get_id("tv")
var layer_tv = layer_background_get_id(layer_tv_id)
if (obj_controller.current_scene == 6)
    layer_background_visible(layer_tv, true)
else
    layer_background_visible(layer_tv, false)
