...
switch example
{
    ...
    case 1:
        ...
        with (obj_input_text)
            draw_sprite(spr_input_0, 0, (x - 16), y)
        break
    case 2:
        draw_set_color(c_silver)
        draw_set_font(ft_info_small)
        ...
        with (obj_input_text)
            draw_sprite(spr_input_1, 0, (x - 16), (y - 16))
        break
    case 3:
        draw_set_color(c_silver)
        draw_set_font(ft_info_small)
        ...
        with (obj_input_text)
            draw_sprite(spr_input_2, 0, (x - origin_x - 12), (y - origin_y - 12))
        break
    case 4:
        draw_set_color(c_silver)
        draw_set_font(ft_info_small)
        ...
        with (obj_input_text)
            draw_sprite(spr_input_2, 0, (x - 12), (y - 12))
        break
    case 5:
        draw_set_color(c_silver)
        draw_set_font(ft_info_small)
        ...
        with (colorful)
            draw_sprite_ext(spr_input_3, 0, x, y, 1, 1, 0, c_orange, 1)
        with (rotated)
            draw_sprite_ext(spr_input_3, 0, x, y, 1, 1, image_angle, c_white, 1)
        with (vertical)
            draw_sprite_ext(spr_input_3, 0, x, y, 1, 1, -90, c_white, 1)
        break
    case 6:
        draw_set_color(c_silver)
        draw_set_font(ft_info_big)
...
if (example == (examples - 1))
{
    ...
    draw_sprite(spr_arrow, 0, (room_width - 50), (room_height - 45))
if (example != 0)
    draw_sprite_ext(spr_arrow, 0, 50, (room_height - 45), -1, 1, 0, c_white, 1)
